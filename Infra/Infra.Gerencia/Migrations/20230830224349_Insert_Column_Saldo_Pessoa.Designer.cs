...
namespace Infra.Gerencia.Migrations
{
    ...
    [Migration("20230830224349_Insert_Column_Saldo_Pessoa")]
    partial class InsertColumnSaldoPessoa
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Gerencia.Entities.Saldo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Gerencia.Entities.Saldo", b =>
                {
                    b.HasOne("Domain.Gerencia.Entities.Pessoa", null)
                        .WithMany("Saldo")
                        .HasForeignKey("Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
