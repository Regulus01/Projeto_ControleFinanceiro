...
namespace Infra.Authentication.Migrations
{
    ...
    [Migration("20230319210025_Add_Relacionamento_PessoaUsuario")]
    partial class AddRelacionamentoPessoaUsuario
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Authentication.Shared.Pessoa", b =>
                {
                    b.HasOne("Domain.Authentication.Entities.Usuario", "Usuario")
                        .WithOne("Pessoa")
                        .HasForeignKey("Domain.Authentication.Shared.Pessoa", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
